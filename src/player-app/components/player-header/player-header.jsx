...
const PlayerHeader = ({ toggleScores, toggleMail, showSettings, togglePersonalize, isScheduleShown, toggleSportsPageSchedule, isProgramShown, toggleLivePlayProgram, isHorsesSelectShown, toggleHorsesPreviewSelect }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PlayerHeader));
