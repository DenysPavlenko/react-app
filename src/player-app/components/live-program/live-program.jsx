...
// Redux
import { fetchLiveProgramData } from 'player-app/redux/live-program/actions';
import { selectLiveProgram } from 'player-app/redux/live-program/selectors';
// Components
import ErrorIndicator from 'shared/components/error-indicator/error-indicator';
import Spinner from 'shared/components/spinner/spinner';
import LiveProgramItem from 'player-app/components/live-program-item/live-program-item';
// Styles
