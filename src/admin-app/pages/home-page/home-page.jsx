...
const HomePage = ({ toggleActivePlayers }) => {
  ...
  const widgets = [
    ...
    { id: 3, title: 'Weekly Figures', value: '-140.00', icon: 'dollar-sign', color: 'danger', onClick: null },
    { id: 4, title: 'Deleted Wagers', value: '0', icon: 'trash-alt', color: 'accent-orange', onClick: null },
  ];
