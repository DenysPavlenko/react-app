...
import HeaderMenu from 'shared/parts/header/header-menu';
import Balance from 'admin-app/components/balance';
import Search from 'shared/components/search';
import SelectAgent from 'admin-app/parts/select-agent';
import HeaderDropdown from 'shared/parts/header/header-dropdown';
import HeaderDropdownMenu from 'shared/parts/header/header-dropdown-menu';
// Assets
