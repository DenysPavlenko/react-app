...
import SportsBettingsItem from 'components/sports-bettings-item/sports-bettings-item';
// Styles
  ...
  return (
    <div className="sports-bettings">
      <div className="sports-bettings__header">
        ...
        <Typography component="h4">0 Selection(s)</Typography>
      </div>
      <WagerTypes />
      <div className="sports-bettings__body">
        <SportsBettingsItem />
      </div>
