...
// Redux
import { toggleActivePlayers } from 'redux/active-players/actions';
import { toggleAccountsClosed } from 'redux/accounts-closed/actions';
// Compoents
import InfoWidgets from 'components/info-widgets';
import RecentLogins from 'parts/recent-logins';
import ActivePlayers from 'parts/active-players';
import AccountsClosed from 'parts/accounts-closed';
import BiggestPendingWagers from 'parts/biggest-pending-wagers';
// Styles
import './styles.sass';
